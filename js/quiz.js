...
export function initQuiz(){
    ...
    const quizData = [
        ...
        {
            question:"Хто перший вирішив познайоситись та проявив ініциативу?",
            answers:[
                {text:"Я, це була Доля", correct:true},
                {text:"Ти, бо Михайсик наговорив багато про мене", correct:false},
